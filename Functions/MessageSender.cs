...
namespace MessageProvider.Functions
{
	public class MessageSender
	{
		...
		public MessageSender(ILoggerFactory loggerFactory, EmailClient emailClient)
		{
		...
		public static void KeepAlive([TimerTrigger("0 */5 * * * *")] TimerInfo myTimer, FunctionContext context)
		{
			var logger = context.GetLogger("KeepAliveFunction");
			logger.LogInformation($"Keep-Alive function executed at: {DateTime.Now}");
		}
	}
}